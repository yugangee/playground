...
*최종 업데이트: 2026-02-28 (팀 승급 조건 체크리스트 추가 / M5-A 훈련계획공유 추가 / M2-B 전반/후반 탭 + M5-A 탭투스왑 전술에디터 추가 / M3-A 시즌필터/PIS/출석왕/POTM + M3-B 상대전적 + M3-E 알림/이의신청 + M2-A QR/체크인/공유 + M2-B 포메이션보드 + M1-B 미납자 리마인드 + M1-C 공유카드 + M1-D SW + M5-A 경기노트)*
